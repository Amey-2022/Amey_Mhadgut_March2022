...
//		author.setName("Alexandar Bail");		
//		author.setEmail("alex@gmail.com"); dao.save(author);
//		dao.save(author);
...
//		 dao.save(book);
		...
		//adding author along with book
		 ...
		 Author author=new Author();
		 author.setName("Amey Mhadgut");
		 author.setEmail("amey@gmail.com");
