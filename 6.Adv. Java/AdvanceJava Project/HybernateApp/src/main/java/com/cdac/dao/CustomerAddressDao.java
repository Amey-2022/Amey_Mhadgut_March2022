...
public class CustomerAddressDao {
	...
	public List<Customer> fetchCustomerByEmail(String domain){
		...
		Query q=em.createQuery("select c from Customer c where c.email like :em");  //HQL/JPQL
	...
	public List<Customer> fetchCustomerByCity(String city){
		...
		Query q=em.createQuery("select c from Customer c join c.address a where a.city= :ct");  //HQL/JPQL
	...
	public Address fetchAddressByCustomerName(String name){
		...
		Query q=em.createQuery("select a from Customer c join c.address a where c.name= :nm");  //HQL/JPQL
