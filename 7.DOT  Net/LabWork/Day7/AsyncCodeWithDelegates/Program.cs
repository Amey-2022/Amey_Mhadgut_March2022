...
namespace AsyncCodeWithDelegates1
{
    class Program
    {
        static void Main1(string[] args)
        {
            ...
            Action o = Display;
            //o(); //sync call
            o.BeginInvoke(null,null); //asyn call
...
namespace AsyncCodeWithDelegates2
{
    class Program
    {
        static void Main2(string[] args)
        {
            ...
            //o(); //sync call
            o.BeginInvoke("hello",null, null); //asyn call
            Console.WriteLine("after");
            Console.ReadLine();
        }
...
namespace AsyncCodeWithDelegates4
{
    class Program
    {
        ...
        static void CallbackFunction(IAsyncResult ar)
        {
            ...
            Console.WriteLine("return value 4: "+retval);
        }
    }
}
    ...
    class Program
    {
        static void Main5()
        {
            ...
            o.BeginInvoke("hello", delegate(IAsyncResult ar)
            {
                ...
                string retval;
                retval = o.EndInvoke(ar);
                Console.WriteLine("return value 5: " + retval);
            }, null); //async call
            Console.WriteLine("after");
...
namespace AsyncCodeWithDelegates6
{
    class Program
    {
        static void Main6()
        {
            Console.WriteLine("before");
            Func<string, string> o = Display;
            //  o.BeginInvoke("hello", CallbackFunction, "extra info"); //async call
            o.BeginInvoke("hello", CallbackFunction, o); //async call
            Console.WriteLine("after");
        ...
        static void CallbackFunction(IAsyncResult ar)
        {
            ...
            string retval;
            retval = o.EndInvoke(ar);
            Console.WriteLine("return value 6: " + retval);
        }
    }
}
...
namespace AsyncCodeWithDelegates7
{
    class Program
    {
        ...
        static void CallbackFunction(IAsyncResult ar)
        {
            ...
            string retval;
            retval = o.EndInvoke(ar);
            Console.WriteLine("return value 7: " + retval);
        }
    }
}
