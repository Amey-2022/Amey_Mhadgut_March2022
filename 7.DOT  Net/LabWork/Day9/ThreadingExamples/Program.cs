...
namespace ThreadingExamples
{
    class Program
    {
        static void Main0(string[] args)
        {
            ...
            //Thread t1 = new Thread(new ThreadStart(Func1));  //alternative conventional method
...
namespace ThreadingExamples3
{
    class MainClass
    {
        ...
        static void Main4()
        {
            ...
            ThreadPool.QueueUserWorkItem(PoolFunc2,"abc");
...
namespace Eg3
{
    class MainClass
    {
        ...
        static void Main()
        {
           ...
           // Thread t2 = new Thread(FunMonitor);
